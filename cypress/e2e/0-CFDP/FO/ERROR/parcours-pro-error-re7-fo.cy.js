...
describe("parcours PRO ERROR FO", () => {
  ...
  it("Parcours Pro Error", () => {
    ...
    getIframeBody()
      ...
      .type(ParcoursData.FO.parcoursPRO.nomEntreprise);

    getIframeBody()
      .find('[role="listbox"]')
      .contains(ParcoursData.FO.parcoursPRO.siret)
      .click();
    ...
    getIframeBody()
      .find('p[class="error-bloquant"]')
      .contains(
        "pas disponible pour les professionnels ayant un CA de plus de 25 000 000"
      )
      .should("be.visible");
