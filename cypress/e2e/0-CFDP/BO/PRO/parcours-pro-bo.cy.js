...
describe("parcours PRO BO", () => {
  beforeEach(() => {
    ...
    getIframeBody()
      .find("input")
      .first()
      .type(ParcoursData.intBO.login.courtier, { force: true });
  ...
  it("Parcours Pro", () => {
    ...
    getIframeBody()
      ...
      .type(ParcoursData.intBO.parcoursPRO.nomEntreprise);
    ...
    getIframeBody()
      ...
      .find('[role="button"]')
      .type(ParcoursData.intBO.parcoursPRO.civilite);
    // Nom & prénom représentant
    getIframeBody()
      .find('[id="nomRepresentant"]')
      .type(ParcoursData.intBO.parcoursPRO.nom);
    getIframeBody()
      .find('[id="prenom"]')
      .type(ParcoursData.intBO.parcoursPRO.prenom);
    // En qualité de
    getIframeBody()
      .find('input[data-cy="qualiteProfessionnelle"]')
      .type(ParcoursData.intBO.parcoursPRO.qualiteProfessionnelle);
    //procédures judiciaires
    getIframeBody()
      .find('[id="nombreProcedures"]')
      .click()
      .type(ParcoursData.intBO.parcoursPRO.nbProcedures);
    // Activité précise
    getIframeBody()
      .find('input[data-cy="activite"]')
      .type(ParcoursData.intBO.parcoursPRO.activite);
    ...
    getIframeBody()
      ...
      .type(ParcoursData.intBO.parcoursPRO.emisPar);
    ...
    getIframeBody()
      ...
      .type(ParcoursData.intBO.parcoursPRO.telephone);
    getIframeBody()
      .find('input[data-cy="mail"]')
      .type(ParcoursData.intBO.parcoursPRO.mail);
    getIframeBody().find("button").contains("Étape suivante").click();
    getIframeBody()
      .find('input[data-cy="fractionnement"]')
      .click()
      .type(ParcoursData.intBO.parcoursPRO.fractionnement, { force: true })
      .type("{enter}", { force: true });
    getIframeBody()
      .find('input[data-cy="moyenDePaiement"]')
      .click()
      .type(ParcoursData.intBO.parcoursPRO.moyenPaiement, { force: true })
      .type("{enter}", { force: true });
